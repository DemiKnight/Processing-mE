 ...
 *     <li><tt>hidden</tt> - WIP continue to setupApplication "update" but remove from renderList</li>
 * </ul>
 * @see RenderManager
 */
public enum RENDER_STATES {
    ...
    hidden // WIP continue to setupApplication "update" but remove from renderList
}
